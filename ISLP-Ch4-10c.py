...
# Calculate the response vector Y using the linear model for training data
Y_train = np.dot(X_train, beta) + epsilon_train
...
plt.title('Forward Selection for Feature Selection')
plt.grid(True)
plt.show()
